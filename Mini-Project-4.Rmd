...
As another step of our analysis, we looked at the number of movies top actors were in. We took the top ten trans actors and the top ten non-trans actors, and compared the number of movies each acted in. Our list of top trans-actors came from the imbd here, and the list of top non-trans actors came from the imdb here: https://www.imdb.com/list/ls004429898/. This showed a vast difference in the number of movies between the two groups; for example, the 5th top trans actress Lana Wachowski is listed with 62 movie productions, while the 5th top non-trans actor Anthony Hopkins is listed with 481 movie productions.
